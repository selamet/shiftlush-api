...
| Şifre asgari uzunluğu | 10 karakter (7.3) | **6 karakter** | Ürün sahibinin kararı. Altı karakter çalınmış bir hash'e karşı zayıftır; buna karşılık yaygın şifre kara listesi ve giriş kilidi (5 denemede 15 dakika) korundu ve argon2id her denemeyi pahalı tutuyor. Karmaşıklık zorunluluğu yine konmadı — `Parola1!` üretmekten başka işe yaramıyor |
